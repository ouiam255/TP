...
import com.test.tp.controllers.StudentController;
...
import java.util.List; // ✅ correction ici : import Java standard, pas JAXB
...
class StudentControllerTest {
    ...
    void testFindAllStudents() {
        ...
        assertEquals(2, response.getBody().size()); // ✅ .size() au lieu de .id()
